...
const page = () => {
    return (
        <div className="relative isolate pt-14 flex flex-col min-h-screen items-center w-full mt-19 bg-black">
            <header className="w-full py-2 flex items-center justify-between px-10 bg-black/95 text-white fixed top-0 left-0 z-[999] backdrop-blur-lg border-b border-gray-500">
            ...
            <HeroHighlight>
                <motion.h1
                    ...
                    className="text-6xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-bold text-black dark:text-black relative z-50"
                >
