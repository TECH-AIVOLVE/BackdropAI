...
const page = () => {
  return (
    <div className="relative isolate pt-14 flex flex-col min-h-screen items-center w-full mt-20 bg-black">
      <header className="w-full py-4 flex items-center justify-between px-10 bg-black text-white fixed top-0 left-0 z-10">
        <div className="flex items-center space-x-4">
          <img src="Logo.ico" alt="BACKDROP AI Logo" className="h-10" />
